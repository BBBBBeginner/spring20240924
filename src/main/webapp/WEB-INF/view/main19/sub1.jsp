...
<%-- action : request parameters가 전달되는 위치, 만약 생략하면 주소창에 작성된 주소를 이용
--%>
<form>
...
<hr>
<form action="/main19/sub2"> <%--sub2로 넘어간다--%>
    <%----%>
...
<hr>
<form action="/main19/sub3"> <%--sub3로 넘어간다--%>
    <%--(input[name][value]--%>
...
<form action="/main19/sub4">
    <input type="text" name="name" value="강인">
    <br>
    ...
    <textarea name="memo" id="" cols="30" rows="10">text area value값은 여기</textarea>
</form>


<hr>
<form action="/main19/sub5"></form>
<br>
<input type="checkbox" name="city" id="" value="seoul">
seoul
<br>
<input type="checkbox" name="city" id="" value="tokyo">
tokyo
<br>
<input type="checkbox" name="city" id="" value="LA">
LA
<br>
<button>전송</button>
</form>
