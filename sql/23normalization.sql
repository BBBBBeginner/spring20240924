...
VALUES ('12345', '소년이 온다', '한강', 10000),
       ('2234531', '채식주의자', '한강', 20000),
       ('3234785', 'git', 'linus', 30000),
       ('42345', '소년이 온다', '한강', 10000);
...
SELECT mt35.name, t36.skill
FROM my_table35 mt35
         JOIN my_table36 t36 ON mt35.id = t35_id;
